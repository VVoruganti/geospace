...
// firebaseRef.child("Text").set("Blablah");
// firebaseRef.child("ABC").set("Blablah");
// firebaseRef.child("ABC").child("DEF").set("Hello");
...
firebaseRef.child("Points").get().then(function(snapshot) {
    if (snapshot.exists()) {
